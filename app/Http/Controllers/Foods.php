...
class Foods extends Controller
{
    ...
    {
        $data = DB::table('food')
                    ->leftjoin('pivot_alergen_food', 'pivot_alergen_food.food_id', '=', 'food.food_id')
                    ->leftjoin('alergen', 'alergen.alergen_id', '=', 'pivot_alergen_food.alergen_id')
                    ->leftjoin('datumy', 'food.food_id', '=', 'datumy.food_id')
                    //->where('datum', '=', '4')
